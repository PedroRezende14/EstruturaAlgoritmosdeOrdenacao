...
public class Decrescente {
    ...
    public static void main(String[] args) {
        ...
        for (int size : sizes) {
            ...
            System.out.println("Descrescente Tamanho: " + size);
            int[] arrayCopy = array.clone();
            SortResult bubbleSortResult = bubbleSortDescending(arrayCopy);
            System.out.println("Bubble Sort Descending - Trocas: " + bubbleSortResult.swaps + ", Comparacoes: " + bubbleSortResult.comparisons + ", Tempo: " + bubbleSortResult.time + " ms (" + bubbleSortResult.getTimeInSeconds() + " s)");

            arrayCopy = array.clone();
            SortResult insertionSortResult = insertionSortDescending(arrayCopy);
            System.out.println("Insertion Sort Descending - Trocas: " + insertionSortResult.swaps + ", Comparacoes: " + insertionSortResult.comparisons + ", Tempo: " + insertionSortResult.time + " ms (" + insertionSortResult.getTimeInSeconds() + " s)");

            arrayCopy = array.clone();
            SortResult selectionSortResult = selectionSortDescending(arrayCopy);
            System.out.println("Selection Sort Descending - Trocas: " + selectionSortResult.swaps + ", Comparacoes: " + selectionSortResult.comparisons + ", Tempo: " + selectionSortResult.time + " ms (" + selectionSortResult.getTimeInSeconds() + " s)");

            arrayCopy = array.clone();
            SortResult mergeSortResult = mergeSortDescending(arrayCopy);
            System.out.println("Merge Sort Descending - Trocas: " + mergeSortResult.swaps + ", Comparacoes: " + mergeSortResult.comparisons + ", Tempo: " + mergeSortResult.time + " ms (" + mergeSortResult.getTimeInSeconds() + " s)");

            arrayCopy = array.clone();
            SortResult quickSortResult = quickSortDescending(arrayCopy);
            System.out.println("Quick Sort Descending - Trocas: " + quickSortResult.swaps + ", Comparacoes: " + quickSortResult.comparisons + ", Tempo: " + quickSortResult.time + " ms (" + quickSortResult.getTimeInSeconds() + " s)");
        }
    }
}
